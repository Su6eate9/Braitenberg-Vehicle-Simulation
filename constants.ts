...
export const INITIAL_MISSIONS: Mission[] = [
  {
    ...
    description:
      "Simule o comportamento de fuga (2a) por 300m para entender padrões de nematódeos.",
    requirement: 300,
    current: 0,
    isCompleted: false,
...
export const VEHICLE_DETAILS = {
  [VehicleType.FEAR]: {
    description:
      "Conexões diretas excitatórias. Foge da fonte, simulando respostas de sobressalto em insetos.",
  ...
  [VehicleType.AGGRESSION]: {
    description:
      "Conexões cruzadas excitatórias. Persegue a fonte agressivamente, similar a predadores simples.",
  ...
  [VehicleType.LOVE]: {
    description:
      "Conexões diretas inibitórias. Aproxima-se e repousa, simulando fototaxia positiva controlada.",
    connections: "Ipsilaterais (-)",
    icon: "favorite",
    color: "text-pink-500",
  ...
  [VehicleType.EXPLORER]: {
    description:
      "Conexões cruzadas inibitórias. Orbita a fonte com curiosidade, investigando o gradiente.",
    connections: "Contralaterais (-)",
    icon: "visibility",
    color: "text-blue-400",
